...
componentWillMount() {
  ...
  render() {
    ...
    animatedSongTittleOpacity = this.animation.y.interpolate({
      ...
      <Animated.View style={{flex:1, backgroundColor: animatedBackgroundColor,}}>
        ...
        style={{height: animatedHeaderHeight, borderTopWidth: 1, borderTopColor: '#ebe5e5', flexDirection: 'row', alignItems: 'center',
          ...
          <View style={{flex: 4, flexDirection:'row', alignItems:'center'}}>
            ...
            <Animated.Text style={{opacity: animatedSongTittleOpacity, fontSize: 18, paddingLeft: 10,}}>
            Hotel California(Live)
            </Animated.Text>
            </View>
            <Animated.View style={{opacity: animatedSongTittleOpacity, flex: 1,flexDirection: 'row', justifyContent: 'space-around'}}>
